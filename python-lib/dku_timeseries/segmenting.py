    ...
    def __init__(self,
        ...
        if self.time_unit == 'row':
            ...
            self.min_segment_duration = pd.Timedelta(
                str(self.min_segment_duration_value) + TIME_STEP_MAPPING.get(self.time_unit, ''))
            self.max_noise_duration = pd.Timedelta(
                str(self.max_noise_duration_value) + TIME_STEP_MAPPING.get(self.time_unit, ''))
